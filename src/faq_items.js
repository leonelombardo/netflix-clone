export const FAQ_ITEMS = [
    ...
    },
    {
        ...
        description: "Watch Netflix on your smartphone, tablet, Smart TV, laptop, or streaming device, all for one fixed monthly fee. Plans range from ARS429 to ARS1,199 a month (pre-tax). No extra costs, no contracts."
    },
    {
        id: 2,
